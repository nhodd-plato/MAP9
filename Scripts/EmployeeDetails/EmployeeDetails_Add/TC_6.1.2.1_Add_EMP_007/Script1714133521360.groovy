...
userName = CustomKeywords.'text.generator.RandomString.createRandomString'()

WebUI.setText(findTestObject('Object Repository/EmployeeDetails/Page_Employee Management/input__username'), userName)

WebUI.setEncryptedText(findTestObject('Object Repository/EmployeeDetails/Page_Employee Management/input__password'), '5Sp1tzkIA9BecA9s35SJIg==')

WebUI.setEncryptedText(findTestObject('Object Repository/EmployeeDetails/Page_Employee Management/input__confirmPassword'), 
    '5Sp1tzkIA9BecA9s35SJIg==')
