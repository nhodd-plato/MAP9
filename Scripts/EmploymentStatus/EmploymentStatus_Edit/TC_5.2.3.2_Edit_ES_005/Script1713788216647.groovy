...
randomText2 = CustomKeywords.'text.generator.RandomString.createRandomString'()

WebUI.setText(findTestObject('Object Repository/EmploymentStatus/Page_Job/input_Add Employment Status_name'), randomText2)
...
if(actualText == randomText2) {
	KeywordUtil.markFailed("ERROR: Should not have saved")
}