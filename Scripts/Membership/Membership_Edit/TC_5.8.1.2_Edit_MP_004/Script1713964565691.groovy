...
WebUI.setText(findTestObject('Object Repository/Membership/Page_Qualifications/input_Add Membership_name'), '')

WebUI.verifyElementPresent(findTestObject('Membership/Page_Qualifications/span_Required'), 0)
