...
WebUI.verifyElementPresent(findTestObject('Object Repository/Membership/Page_Qualifications/th_Membership   arrow_upward'),0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Membership/Page_Qualifications/i_add'),0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Membership/Page_Qualifications/span_test'),0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Membership/Page_Qualifications/i_ohrm_edit'),0)
