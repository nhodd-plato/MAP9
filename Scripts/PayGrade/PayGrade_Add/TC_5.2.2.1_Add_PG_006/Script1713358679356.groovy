...
WebUI.setText(findTestObject('Object Repository/PayGrade/Page_Job/input_Add Pay Grade_name'), 'Executive')

WebUI.click(findTestObject('Object Repository/PayGrade/Page_Job/a_Save'))

WebUI.verifyElementPresent(findTestObject('Object Repository/PayGrade/Page_Job/span_Already exists'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/PayGrade/Page_Job/div_Add Pay Grade Name Already exists Requi_830832'), 
    0)
