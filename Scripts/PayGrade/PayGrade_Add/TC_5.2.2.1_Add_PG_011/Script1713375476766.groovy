...
WebUI.verifyNotMatch(WebUI.getText(findTestObject('Object Repository/PayGrade/Page_Job/name1')),
	WebUI.getText(findTestObject('Object Repository/PayGrade/Page_Job/name2')), true)
